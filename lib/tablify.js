...
(function() {
  var isArrayOfArrays, printer;

  exports.tablify = function(arr, opts) {
  ...
  printer = (function() {
    ...
    function printer(opts) {
      this.opts = opts || {};
      this.opts.spacer = this.opts.spacer || " | ";
      this.opts.row_start = this.opts.row_start || "| ";
      this.opts.row_end = this.opts.row_end || " |";
      this.opts.row_sep_char = "-";
